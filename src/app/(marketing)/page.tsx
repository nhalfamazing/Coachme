...
export default function LandingPage() {
  return (
    <main>
      ...
      <section className="mk-hero">
        <div className="mk-wrap mk-hero-in">
          <div className="mk-hero-copy">
            <p className="mk-eyebrow mono">Free for athletes · Built family-first</p>
      ...
      {/* ---------------- problem ---------------- */}
      <section className="mk-section mk-section--lift" aria-labelledby="problem-h">
        <div className="mk-wrap">
          <p className="mk-label mono">The problem</p>
      ...
      <section className="mk-section" id="how-it-works" aria-labelledby="hiw-h">
        <div className="mk-wrap">
          <p className="mk-label mono">How it works</p>
          ...
          <div className="mk-steps">
            <div className="mk-step">
              <div className="mk-step-num display">1</div>
            ...
            <div className="mk-step">
              <div className="mk-step-num display">2</div>
            ...
            <div className="mk-step">
              <div className="mk-step-num display">3</div>
      ...
      <section className="mk-section mk-section--lift" aria-labelledby="features-h">
        <div className="mk-wrap">
          <p className="mk-label mono">What&apos;s inside</p>
          ...
          <div className="mk-grid mk-grid--2">
            <div className="mk-card">
              <span className="mk-tag mono">Workouts</span>
            ...
            <div className="mk-card">
              <span className="mk-tag mono">Self / Trainer / Facility / Event</span>
            ...
            <div className="mk-card">
              <span className="mk-tag mono">AI Coach · labeled</span>
            ...
            <div className="mk-card">
              <span className="mk-tag mono">Messaging</span>
            ...
            <div className="mk-card">
              <span className="mk-tag mono">No email needed</span>
            ...
            <div className="mk-card">
              <span className="mk-tag mono">For coaches</span>
      ...
      {/* ---------------- honest traction ---------------- */}
      <section className="mk-section" aria-labelledby="today-h">
        <div className="mk-wrap">
          <p className="mk-label mono">Where we are today</p>
      ...
      {/* ---------------- coaches strip ---------------- */}
      <section className="mk-section mk-section--lift" id="coaches" aria-labelledby="coach-h">
        <div className="mk-wrap">
          <p className="mk-label mono">For coaches</p>
      ...
      {/* ---------------- FAQ ---------------- */}
      <section className="mk-section" id="faq" aria-labelledby="faq-h">
        <div className="mk-wrap">
          <p className="mk-label mono">FAQ</p>
